# Active plan:pre planner contributions (Phase 04.1)

Inject/obey each block below as if inlined in your prompt.
...
**Resolved configValues:** `{"security_asvs_level":1,"security_block_on":"high"}`
